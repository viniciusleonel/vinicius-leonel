...
export default function About () {
    return (
        <div className="w-full mt-0 xs:mt-16 mx-8 lg:mx-20 bg-white dark:bg-dark-secondary border-2 border-cyan-700 dark:border-cyan-500 rounded-3xl">
            ...
            <div className="p-4 sm:px-8 md:px-10 lg:px-14 flex flex-col sm:flex-row items-center justify-center  w-full">
                <div className="w-full ">
                    ...
                    <p className={`${lusitana.className} mt-6 text-sm md:text-base text-zinc-800 dark:text-zinc-300`}>
                        Currently in the last year course of System Development and Analysis at FIAP + Alura. 
                        <br />
                        <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-600">Main skills: Java, Spring, NodeJs, NextJs, TypeScript, React, English.</span>
                        <br />
