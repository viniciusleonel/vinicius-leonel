...
export default function Contact () {
    return (
        <div className="px-6 bg-cyan-100  dark:bg-zinc-900 flex flex-1 items-center justify-center p-4 w-full border border-cyan-700 rounded-3xl">
            <div>
                ...
                <p className="mt-6 ms-2 w-3/4 text-sm md:text-base text-zinc-800 dark:text-zinc-400">
