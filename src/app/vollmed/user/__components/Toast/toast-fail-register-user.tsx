...
export function ToastFailUserRegister({closeToaster, error} :ToastUserRegisterProps) {
    return (
        <>
        ...
        <div className="fixed top-1/2 left-1/2 z-50 w-full max-w-sm -translate-x-1/2 -translate-y-1/2 animate-slide-in-up">
            ...
            <div className="flex items-start justify-between">
                ...
                <h3 className="text-lg font-medium text-white dark:text-white">Falha ao cadastrar usuário!</h3>
                <p className="text-sm text-white dark:text-white">Usuário em uso, tente com outro email {error?.message}.</p>
                </div>
                <Button
