...
export function ToastRegisterMedico({closeToaster, medico} :ToastRegisterMedicoProps) {
    return (
        <>
        ...
        <div className="fixed top-1/2 left-1/2 z-50 w-full max-w-sm -translate-x-1/2 -translate-y-1/2 animate-slide-in-up">
            ...
            <div className="flex items-start justify-between">
                ...
                <h3 className="text-lg font-medium text-white dark:text-white">Médico Cadastrado</h3>
                <p className="text-sm text-white dark:text-white">Médico <span className="text-green-900 underline">{medico.nome}</span> cadastrado com sucesso!</p>
                </div>
                <Button
