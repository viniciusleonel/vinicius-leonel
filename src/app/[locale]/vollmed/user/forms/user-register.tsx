...
import { ToastRegisterUser } from "@/app/[locale]/vollmed/user/__components/Toast/toast-register-user";
import { ToastFailUserRegister } from "@/app/[locale]/vollmed/user/__components/Toast/toast-fail-register-user";
...
export default function UserRegister({
    ...
    const [userToastSucess, setUserToastSucess] = useState<Usuario | null>(
        null
    );
    ...
    const {
        ...
        formState: { errors: errorsUser, isSubmitting },
        watch,
        ...
        >
            ...
            <div className="flex flex-col relative">
                ...
                {errorsUser.confirmPassword && (
                    <span className="text-red-500 pt-2">
                        {errorsUser.confirmPassword.message}
                    </span>
                )}
            </div>
